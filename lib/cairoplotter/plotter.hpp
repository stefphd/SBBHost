...
#ifndef M_PI //add if not defined (like in Win)
...
namespace CarioGraphConstants
{
    ...
    constexpr double OFFSET_X = 0.1;
    constexpr double OFFSET_Y = 0.1;
    constexpr double GRAPH_WIDTH = 0.8;
    constexpr double GRAPH_HEIGHT = 0.8;
...
namespace CGraph
{
    ...
    public:
        ...
        // graph methods
        void set_graph_size(double x, double y, double w, double h);
        void update_graph();
        ...
        void add_point(size_t seriesnum, const double x, const double y, bool update_xminmax = true, bool update_yminmax = true);
        ...
        void set_label_scale(double sc = 1);
        void set_tick_scale(double sc = 1);
        void set_xwindow(int len = 0);
        void clear_series(size_t seriesnum);
        size_t get_num_series();
        void reset_limits();
        void reset_xlim();
        void reset_ylim();
        void update_ylim(double y1 = -1, double y2 = +1);
    ...
    private:
        ...
        double offset_x = CarioGraphConstants::OFFSET_X;
        double offset_y = CarioGraphConstants::OFFSET_Y;
        double graph_width = CarioGraphConstants::GRAPH_WIDTH;
        double graph_height = CarioGraphConstants::GRAPH_HEIGHT;
